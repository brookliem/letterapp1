...
<html lang="{{ app()->getLocale() }}">
        ...
        <div class="mB-40" style="margin-top: 30px;">
            <div class="p-30">
                <table class="table border-0" style="margin-left: auto; margin-right: auto">
                    <tr>
                        <p style="text-align: center; font-size:13.2px; margin-left: auto; margin-right: auto"><strong
                                style="font-size: 26px">PT CITA MINERAL
                                INVESTINDO
                                Tbk</strong>
                            <br>
                ...
                <table class="table table-bordered"
                    ...
                    <tr>
                        <td> No <br> Lampiran <br> Perihal</td>
                        <td>: <br> : <br> : </td>
                        <td style="width: 512px; margin-right:30px">{{ $templates["imnumber"] }}
                            <span style="float:right; margin-right:-20px">
                                {{ \Carbon\Carbon::parse($templates["date"])->format("d F Y") }}</span>
                            <br>{{ $templates["lampiran"] }}
                            <br>{{ $templates["perihal"] }}
                        </td>
                    </tr>
                </table>
                <br>
                    ...
                    <table class="tg" style="margin-left: auto; margin-right: auto;">
                        <thead>
                            <tr>
                                ...
                                <th class="tg-0lax" style="width: 150px; font-size:15.5px;">Disetujui oleh,</th>
                            </tr>
                        </thead>
                        <tbody style="text-align: center">
                            <td style="height: 90px;">
                                @if (isset($templates["tandatangan1"]))
                                    <img src="{{ asset("upload/user-tandatangan/{$templates["tandatangan1"]}") }}">
                                @endif
                            </td>

                            <td style="height: 90px;">
                                @if (isset($templates["tandatangan2"]))
                                    <img src="{{ asset("upload/user-tandatangan/{$templates["tandatangan2"]}") }}">
                                @endif
                            </td>

                            <td style="height: 90px;">
                                @if (isset($templates["tandatangan3"]))
                                    <img src="{{ asset("upload/user-tandatangan/{$templates["tandatangan3"]}") }}">
                                @endif
                            </td>

                            <td style="height: 90px;">
                                @if (isset($templates["tandatangan4"]))
                                    <img src="{{ asset("upload/user-tandatangan/{$templates["tandatangan4"]}") }}">
                                @endif
                            </td>
                        </tbody>
            ...
            <div class="mB-40" style="margin-top: 30px;">
                <div class="p-30">
                    <table class="table border-0">
                        <tr>
                            <p style="text-align: center; font-size:13.2px;"><strong style="font-size: 26px">PT CITA
                                    MINERAL INVESTINDO Tbk</strong>
                                <br>
                                Panin Bank Building Lantai 2, Jl. Jend Sudirman - Senayan Jakarta Pusat 10270<br>
                                Telp. (021) - 7251344 Fax (021) - 72789885<br>
                            </p>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="font-size: 14px;">Rp <span
                                        style="float: right">{{ number_format($totalValue, 2, ",", ".") }}</span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <script>
        @if (session("targetBlank"))
            const printWindow = window.open('{{ url("print2") }}', '_blank');
